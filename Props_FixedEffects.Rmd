...
data.sc_r_f2$mm_dir_dv_adj <- p.adjust(data.sc_r_f2$mm_dir_dv, method = "BH") 
data.sc_r_f2$mm_dir_dir_adj <- p.adjust(data.sc_r_f2$mm_dir_dir, method = "BH")
data.sc_r_f2$mm_dir_dv_dir_adj <- p.adjust(data.sc_r_f2$mm_dir_dv_dir, method = "BH")
