...
table_path <- paste0(getwd(), "/Tables/TableS2.html")
...
table_path <- paste0(getwd(), "/Tables/TableS3.html")
...
table_path <- paste0(getwd(), "/Tables/TableS4.html")
...
table_path <- paste0(getwd(), "/Tables/TableS5.html")
...
table_path <- paste0(getwd(), "/Tables/TableS6.html")
...
table_path <- paste0(getwd(), "/Tables/TableS7.html")
...
table_path <- paste0(getwd(), "/Tables/TableS8.html")
...
FE_Full_table <-data.sc_r_f2_all %>%
  ...
  mutate(full_dvlocmm = map_dbl(ANOVA, ~.$'Pr(>F)'[1])) %>%
  mutate(full_expr = map_dbl(ANOVA, ~.$'Pr(>F)'[2])) %>%
  mutate(full_housing = map_dbl(ANOVA, ~.$'Pr(>F)'[3])) %>%
  mutate(full_mlpos = map_dbl(ANOVA, ~.$'Pr(>F)'[4])) %>%
  mutate(full_patchdir = map_dbl(ANOVA, ~.$'Pr(>F)'[5])) %>%
  mutate(full_dvlocmm_housing = map_dbl(ANOVA, ~.$'Pr(>F)'[6])) %>%
  mutate(full_dvlocmm_expr = map_dbl(ANOVA, ~.$'Pr(>F)'[7])) %>%
  mutate(full_dvlocmm_patchdir = map_dbl(ANOVA, ~.$'Pr(>F)'[8])) %>%
  mutate(full_dvlocmm_mlpos = map_dbl(ANOVA, ~.$'Pr(>F)'[9])) %>%
  select(-ANOVA)
