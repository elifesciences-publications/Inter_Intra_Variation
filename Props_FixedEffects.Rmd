...
```{r}
data.sc_r_all$mm_full_fixed_vslinear_pdiff_adj <- p.adjust(data.sc_r_all$mm_full_fixed_vslinear_pdiff, method = "BH")
table_mixedvslinear(data.sc_r_all, "mm_full_fixed_vslinear")
```
...
Compare the full mixed with the equivalent linear model.
```{r}
data.sc_r <- mixed_vs_linear_pchisqu(data.sc_r,
                                         mm_min1,
                                         lin_min1)

data.sc_r$mm_min1_vslinear_pdiff_adj <- p.adjust(data.sc_r$mm_min1_vslinear_pdiff, method = "BH")

table_mixedvslinear(data.sc_r, "mm_min1_vslinear")
```
