...
data.sc_r <- data.sc_r %>%
  ...
  mutate(mm_housing_dvlocmm = map_dbl(mm_vsris_housing_ANOVA, ~.$`Pr(>Chisq)`[[1]])) %>%
  ...
  mutate(mm_housing_dvlocmm_adj = 1)

data.sc_r$mm_housing_dvlocmm_adj <- p.adjust(data.sc_r$mm_housing_dvlocmm, method = "BH")
...
kableExtra::kable(select(data.sc_r[1:12,],
                         ...
                         mm_housing_nobs,
                         mm_housing_dvlocmm,
                         mm_housing_dvlocmm_adj,
                         mm_vsris_housing_ANOVA_housing,
                         mm_vsris_housing_ANOVA_dvlocmm_housing),
                  col.names = c("property", "N", "n", "dvloc", "dvloc_adj", "housing", "dvloc:housing")) %>%
