...
(Q_neurons_plot <- corrplot(Q_neurons, type = "lower", order = "original", diag = FALSE))
```
...
(Q_intercepts_plot <- corrplot(Q_intercepts, type = "upper", diag = FALSE, order = "alphabet"))
```
