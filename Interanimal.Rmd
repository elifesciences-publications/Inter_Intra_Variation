...
Compare linear models with mixed models. Does adding random effects lead to a statistically different model? Need to seperate out functions that are repeated elsewhere. Repeat them here with different names to avoid dependencies.
```{r Compare linear with mixed models}
