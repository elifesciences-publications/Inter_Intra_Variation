...
Look at effect of hmemisphere on sag and resonance magnitude plotted as a function of location.
```{r}
ggplot(drop_na(filter(data.sc_r, property == "sag")$data[[1]]), aes(dvlocmm, value, colour = hemi)) +
  geom_point() +
  geom_smooth(method='lm')

ggplot(drop_na(filter(data.sc_r, property == "resmag")$data[[1]]), aes(dvlocmm, value, colour = hemi)) +
  geom_point() +
  geom_smooth(method='lm')
```
