...
Example code
mm$fit <- predict(model_vsris_housing)
...
```{r}
predictplot_ir <- predict_plot(filter(data.sc_r, property == "ir")$data[[1]],
...
predictplot_rheo <- predict_plot(filter(data.sc_r, property == "rheo")$data[[1]],
...
predictplot_resf <- predict_plot(filter(data.sc_r, property == "resf")$data[[1]],
