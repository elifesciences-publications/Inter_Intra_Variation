...
```{r}
fe_hemi_sag <- merTools::FEsim(filter(data.sc_r, property == "sag")$mm_vsris_hemi[[1]])

merTools::plotFEsim(fe_hemi_sag) + ggtitle("Fixed effects for sag")

fe_hemi_resmag <- merTools::FEsim(filter(data.sc_r, property == "resmag")$mm_vsris_hemi[[1]])

merTools::plotFEsim(fe_hemi_resmag) + ggtitle("Fixed effects for resonance magnitude")
```
