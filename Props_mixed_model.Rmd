...
Idea is from: https://stackoverflow.com/questions/13847936/in-r-plotting-random-effects-from-lmer-lme4-package-using-qqmath-or-dotplot
```{r}
fit <- filter(data.sc_r, property == "rheo")$mixedmodel_vsris
randoms <- merTools::REsim(fit[[1]], n.sims = 500)
