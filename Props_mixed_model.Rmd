...
data.sc_r <- data.sc_r %>%
  mutate(pdiff_adj= p.adjust(data.sc_r$mm_vsris_vslinear_pdiff, method = "BH"))
```
...
data.sc_TP_r <- data.sc_TP_r %>%
  mutate(pdiff_adj = p.adjust(data.sc_TP_r$mm_vsris_vslinear_pdiff, method = "BH")) 

data.sc_TP_r <- mixed_vs_linear_pchisqu(data.sc_TP_r, mm_vsris_1, linearmodel_1)

data.sc_TP_r <- data.sc_TP_r %>%
  mutate(pdiff_1_adj = p.adjust(data.sc_TP_r$mm_vsris_1_vslinear_pdiff, method = "BH"))
